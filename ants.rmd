...
The following example is using Ants model (Wilensky 1997) to show 
...
When parameters (`param_values`) are defined as a list of value vecors, parameter sets are
constructed as combination of all possible parameter value combination 
what is called "full factorial design". 
In practice it is feasible with few parameters and small number of factors
for each parameter.
See [sampling methods](sampling.html) for advanced usage of `param_values`.
...
## Related
See [Fur Patterns](fur.html) example to see
