...
```
<aside>
`agents_step` defines temporal disaggregated measure (all agents per each step)
</aside>
...
```{r trafficPlot, title = "Plot cars", fig.cap="Position of _n_ cars in time. Position of selected car is marked by red.", fig.height=4}
library(ggplot2)
...
```{r trafficPlot2, title = "Plot cars", fig.cap="Speed of _n_ cars in time. Speed of selected car is marked by red."}
library(ggplot2)
