...
```{r pFlockOptimPlot, title = "Plot tracing data", dev.args = list(bg = 'transparent')}
tr <- trace$get()
...
```{r pFlockOptimPlot2, title = "Plot tracing data", fig.cap="Where did `optim` look for best value?", dev.args = list(bg = 'transparent')}
library(ggplot2)
