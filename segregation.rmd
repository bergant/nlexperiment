...
is good enough for aggregate measures, there are occasions when we need to measure 
values for each agent individually. Example below is using 
Netlogo Segregation model (Wilensky, 1997) from NetLogo model library.
