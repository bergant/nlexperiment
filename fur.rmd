...
explicit parameter values definition.
...
`ratio * rdiff` while keeping the `gap` between the circles constant.
...
```
<aside>
R function `expand.grid` creates a data frame from all combinations of factors
