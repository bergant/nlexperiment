...
<experiment>__R package for exploration of  NetLogo^1^ agent based models.__</experiment>
<asideclose>
...
All examples in the [tutorial](tutorial.html) also link to
their rmarkdown source file (follow the last side note on each sample page).
To learn more about creating documents with R see
