...
Some examples in the [tutorial](tutorial.html) follow the 
  ...
  where you can find more methods and are described in more detail. 

Using NetLogo flocking model and related experiment definitions are inspired by (Stonedahl, 2011),
