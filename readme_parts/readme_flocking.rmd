...
```{r pFlockRun1, cache=TRUE} 
result <- nl_run(experiment)       
```

Plot results

```{r pFlockPlot1, fig.width=3.2, fig.height=3.2, fig.show='hold'}
...
Plot the result:
```{r pFlockPlot5, fig.show='hold', fig.width=3.2, fig.height=3.2}
